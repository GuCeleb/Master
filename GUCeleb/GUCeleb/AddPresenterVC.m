...
// Delegeate method return from te Image Picker and then set the iamge from the chosen one
...
// Show image picker controller and give option to the user to select a picture
...
// Add new presentor to the database
...
// Helper method for showing UIAlertController for any error
